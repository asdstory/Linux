...
### Note: 
- This command only work for RELION 3.0 version. For .star file generated by RELION 3.1, you need to optimize the NR and column number according to new version star file. 
