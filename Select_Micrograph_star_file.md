...
- For RELION 3.0:
- [ ] awk 'NR <= 18 {print $0 > "micrographs_new.star"} NR >18 && $3 >= 5000 && $3 <=30000 && $5 <= 1000 && $13 <=4 {print $0 >> "micrographs_new.star"}' micrographs.star
- If you are using RELION 3.1: 
- [ ] awk 'NR <= 30 {print $0 > "micrographs_new.star"} NR >30 && $4 >= 5000 && $4 <=30000 && $6 <= 1000 && $9 <=4 {print $0 >> "micrographs_new.star"}' micrographs.star
- How to count how many graphs selected: 
- [ ] grep MotionCor micrographs_new.star | wc -l
